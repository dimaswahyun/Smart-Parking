...
public class ClassA6 extends Activity {
    ...
    public class TampilSemuaKomentar extends AsyncTask<Void, Void, Boolean> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            progressBarNya = new ProgressDialog(ClassA6.this);
...
//            updateListViewNya();
    ...
    protected void onResume() {
        ...
        new ClassA6.TampilSemuaKomentar().execute();
    }
    public void jsonDataNyaDiUpdate() {
        ...
        SharedPreferences sharedPrefNya = PreferenceManager.getDefaultSharedPreferences(ClassA6.this);
        ...
        try {
            ...
            for (int i = 0; i < semuaKomentar.length(); i++) {
                ...
                if (node.equals("A6")&&statusnya.equals("1")) {

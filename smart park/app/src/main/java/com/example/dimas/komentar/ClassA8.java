...
public class ClassA8 extends Activity {
    ...
    public class TampilSemuaKomentar extends AsyncTask<Void, Void, Boolean> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            progressBarNya = new ProgressDialog(ClassA8.this);
...
//            updateListViewNya();
    ...
    protected void onResume() {
        ...
        new ClassA8.TampilSemuaKomentar().execute();
    }
    public void jsonDataNyaDiUpdate() {
        ...
        SharedPreferences sharedPrefNya = PreferenceManager.getDefaultSharedPreferences(ClassA8.this);
        ...
        try {
            ...
            for (int i = 0; i < semuaKomentar.length(); i++) {
                ...
                if (node.equals("A8")&&statusnya.equals("1")) {

...
public class ClassA7 extends Activity {
    ...
    public class TampilSemuaKomentar extends AsyncTask<Void, Void, Boolean> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            progressBarNya = new ProgressDialog(ClassA7.this);
...
//            updateListViewNya();
    ...
    protected void onResume() {
        ...
        new ClassA7.TampilSemuaKomentar().execute();
    }
    public void jsonDataNyaDiUpdate() {
        ...
        SharedPreferences sharedPrefNya = PreferenceManager.getDefaultSharedPreferences(ClassA7.this);
        ...
        try {
            ...
            for (int i = 0; i < semuaKomentar.length(); i++) {
                ...
                if (node.equals("A7")&&statusnya.equals("1")) {

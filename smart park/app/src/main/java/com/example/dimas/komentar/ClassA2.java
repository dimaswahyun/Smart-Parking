...
public class ClassA2 extends Activity {
    ...
    public class TampilSemuaKomentar extends AsyncTask<Void, Void, Boolean> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            progressBarNya = new ProgressDialog(ClassA2.this);
...
//            updateListViewNya();
    ...
    protected void onResume() {
        ...
        new ClassA2.TampilSemuaKomentar().execute();
    }
    public void jsonDataNyaDiUpdate() {
        ...
        SharedPreferences sharedPrefNya = PreferenceManager.getDefaultSharedPreferences(ClassA2.this);
        ...
        try {
            ...
            for (int i = 0; i < semuaKomentar.length(); i++) {
                ...
                if (node.equals("A2")&&statusnya.equals("1")) {

...
public class ClassA4 extends Activity {
    ...
    public class TampilSemuaKomentar extends AsyncTask<Void, Void, Boolean> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            progressBarNya = new ProgressDialog(ClassA4.this);
...
//            updateListViewNya();
    ...
    protected void onResume() {
        ...
        new ClassA4.TampilSemuaKomentar().execute();
    }
    public void jsonDataNyaDiUpdate() {
        ...
        SharedPreferences sharedPrefNya = PreferenceManager.getDefaultSharedPreferences(ClassA4.this);
        ...
        try {
            ...
            for (int i = 0; i < semuaKomentar.length(); i++) {
                ...
                if (node.equals("A4")&&statusnya.equals("1")) {
